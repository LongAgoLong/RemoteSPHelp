...
class SPImpl {
    private static final String SP_NAME = "REMOTE_SP";
    ...
    static synchronized <T> void save(Context context, String name, T t) {
    ...
    private static Object getImpl(Context context, String name, String type) {
        if (!contains(context, name)) {
            ...
            if (type.equalsIgnoreCase(SpContants.TYPE_STRING)) {
                return getString(context, name, null);
            } else if (type.equalsIgnoreCase(SpContants.TYPE_BOOLEAN)) {
                return getBoolean(context, name, false);
            } else if (type.equalsIgnoreCase(SpContants.TYPE_INT)) {
                return getInt(context, name, 0);
            } else if (type.equalsIgnoreCase(SpContants.TYPE_LONG)) {
                return getLong(context, name, 0L);
            } else if (type.equalsIgnoreCase(SpContants.TYPE_FLOAT)) {
